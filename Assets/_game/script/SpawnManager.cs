...
public class SpawnManager : MonoBehaviour
{
    ...
    private void ApplyMaterial(GameObject obj, string colorName)
    {
        ...
        var block = obj.GetComponentInChildren<SpriteRenderer>();
        var blockComponent = obj.GetComponent<Block>();
        if (block == null || blockComponent == null) return;
        blockComponent.color = colorName;
        block.color = ColorGameConfig.instance.GetColorByName(colorName);
    }
